  ...
  return (
    <div className="navbar">
        ...
        <div className="productOptions">
          <ul>
            <li> <button className="button">Gelato</button></li>
            <li> <button className="button">Gelato for special needs</button></li>
            <li> <button className="button">Donuts</button></li>
            <li> <button className="button">Donuts for special needs</button></li>
          </ul>
        </div>
